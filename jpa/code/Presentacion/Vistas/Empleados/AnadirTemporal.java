...
public class AnadirTemporal extends JPanel{
									...
									try {
										...
										if(nssText.getText().isEmpty() || nombreText.getText().isEmpty() || emailText.getText().isEmpty() || 
											...
											if(!departamentoText.getText().isEmpty()) {
												...
												Controlador.getInstancia().tratarPeticion(new Contexto("CrearEmpleado", new TemporalBO(nombreText.getText(),
