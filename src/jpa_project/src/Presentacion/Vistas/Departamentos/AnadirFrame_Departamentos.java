...
public class AnadirFrame_Departamentos extends JPanel{
	 ...
	 * Constructor
	 */
	public AnadirFrame_Departamentos (){
				...
				new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						try {
								...
								Controlador.getInstancia().tratarPeticion(new Contexto("CrearDepartamento", new DepartamentoBO(nombreText.getText())));
							}
						}
