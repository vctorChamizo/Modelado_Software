...
public class ActualizarParticular extends JPanel{
	...
	private JTextField nombreText, apellidoText, dniText, emailText, telefonoText;

	
	/**
	 * Constructor
	 * 
	 * @param particular ParticularTrans
	 */
	public ActualizarParticular(ParticularTrans particular){
		...
		this.activo = particular.getActivo();
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							...
							if(dniText.getText().isEmpty() || nombreText.getText().isEmpty() || 
								...
								Controlador.getInstancia().tratarPeticion(new Contexto("ModificarCliente", new ParticularTrans(id, nombreText.getText(),
